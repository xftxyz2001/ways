...
echo:                                                          
call :_color2 %_White% "          [3] �л� Windows ����ǽ  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                          
echo:          [4] ˵���ĵ�                                  
echo:          [5] �˳�                                        
echo:       ___________________________________________________
echo:   
call :_color2 %_White% "        " %_Green% "�ڼ��� [1,2,3,4,5] ������˵�ѡ��"
choice /C:12345 /N
set _erl=%errorlevel%
...
call :_color %Green% "IDM ���� - ��ע����гɹ�����"
) else (
call :_color %Red% "�޷���ȫ���� IDM ���� - ����"
)
...
if not exist "!IDMan!" (
call :_color %Red% "δ��װ IDM [Internet Download Manager] "
...
echo %line%
echo:
call :_color %Green% "IDM �ѳɹ�����"
echo:
call :_color %Gray% "���������ʾ���֣��ٴ����м���ѡ�֮�����Ͳ��������"
goto done
)
