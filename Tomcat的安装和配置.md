...
2. 选择需要的版本，推荐使用Tomcat8版本及以上版本，但是也不用追求最新版本。此处示范Tomcat10版本，如图，单击即可。（还是采用8.x版本会比较方便，10.x目前还存在很多问题）
   - ![1657757822522](image/Tomcat的安装和配置/1657757822522.png)
3. 这里有解压版及安装版可供选择，解压版需要下载对应自己电脑系统的位数，安装版通用。此处使用64位的解压版。
   - ![1657757871042](image/Tomcat的安装和配置/1657757871042.png)
